...
const About = memo(function About() {
    ...
    const textOpacity1 = useTransform(scrollYProgress, [0.1, 0.2], [0, 1]);
    const textY1 = useTransform(scrollYProgress, [0.1, 0.2], [40, 0]);

    const textOpacity2 = useTransform(scrollYProgress, [0.2, 0.3], [0, 1]);
    const textY2 = useTransform(scrollYProgress, [0.2, 0.3], [40, 0]);

    const textOpacity3 = useTransform(scrollYProgress, [0.3, 0.4], [0, 1]);
    const textY3 = useTransform(scrollYProgress, [0.3, 0.4], [40, 0]);

    return (
        <section
            id="about"
            ref={sectionRef}
            className="py-24 md:py-32 lg:py-40 relative min-h-screen flex items-center bg-black overflow-hidden z-10 w-full"
        >
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 w-full">
                ...
                >
                    ...
                    <motion.div style={{ y: y1 }} className="flex flex-col gap-8">
                        ...
                        <div>
                            <h2 className="text-sm font-semibold tracking-widest uppercase text-white/40 mb-3">
                                The Story
                            </h2>

                            <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-white leading-tight">
                                Crafting the <br />
                    ...
                    <motion.div
                        style={{ y: y2 }}
                        className="relative flex items-center justify-center w-full perspective-[1200px]"
                    >

                        {/* glow background */}

                        <div className="absolute w-[520px] h-[520px] bg-indigo-500/20 blur-[160px] rounded-full animate-pulse" />

                        <motion.div
                            whileHover={{ scale: 1.03 }}
                            transition={{ type: "spring", stiffness: 120 }}
                            className="relative w-[420px] h-[580px] rounded-[34px]
                            border border-white/10
                            bg-[#0b0d14]
                            shadow-[0_60px_150px_rgba(0,0,0,0.9)]
                            overflow-hidden group"
                        >

                            {/* browser bar */}

                            <div className="h-10 bg-[#12141c] border-b border-white/5 flex items-center px-4 gap-2">
                                ...
                                <div className="mx-auto text-xs text-white/40 font-mono">
                            ...
                            <div className="flex items-center justify-center gap-4 py-5 bg-black/50 backdrop-blur-lg">
